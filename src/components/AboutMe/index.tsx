  ...
  return (
    <AboutMeContainer>
      <p>
        ...
        PostgreSQL, e sempre buscando seguir as melhores práticas de programação
      ...
      <p>
        Se você está à procura um programador criativo, orientado a resultados e
        com habilidades interpessoais sólidas, estou pronto para embarcar em
        novos desafios e criar algo extraordinário. Vamos juntos desbravar novos
        horizontes nesse universo da programação!
      </p>
    </AboutMeContainer>
  )
}
